...
Deep learning has gained a lot of popularity in recent years with success in image recognition, test-to-speech, motion tracking and singing voice transcription. The success of deep learning is attributed to the fact that large non-linear models can be trained using back propogation. The tradeoff with these complex, non-linear models is that it is difficult to interpret what is being learned by the deep learning model. Szegedy et al. \cite{szegedy_intriguing_2013} discovered that in object recognition tasks by applying an imperceptible non-random perturbation to the input image the output of the network can be changed. They coined the term "Adversarial examples" to describe these perturbed images.
