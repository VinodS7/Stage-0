...
\item DeepFool - 
\item Carlini and Wagner - Carlini and Wagner introduce a strong set of attacks based on the $L_0$, $L_2$ and $L_inf$ distance \cite{C&W}. The problem for adversarial attacks is formulated the same was as Szegedy et al. \cite{szegedy_}. The classifier is denoted as $C$ with input $x$:
\begin{align*}
