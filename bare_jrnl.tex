...
Goodfellow, Shlens and Szegedy \cite{goodfellow_explaining_2014} challenged the idea that adversarial examples were due to blind spots in high dimensional spaces. Instead, they suggested that they are caused due to linearity in deep learning models. According to them LSTMS \cite{hochreiter_long_1997}, ReLUs \cite{maas_rectier_nodate}, maxout networks \cite{zhang_improving_2014} etc. were intentiaonally designed to behave more linearly in order to make them easier to optimize. %Cite LSTMS, ReLUs and maxout
